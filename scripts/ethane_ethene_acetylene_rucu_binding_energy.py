...
Uses metalsurfer substitute_alloy to create RuCu alloy from Ru(0001) base slab.
...
def main():
    results_subdir = "ethane_ethene_acetylene_rucu"
    ...
    # Substitute 1/2 of Ru with Cu to form RuCu alloy
    ...
    for smiles, name in MOLECULES:
        ...
        if results:
            ...
            print(
                f"Binding energy of {name} on RuCu(0001): {best.energy_adsorption:.4f} eV"
            )
            if orientations:
                print(
    ...
    # Final summary
    print("\n" + "=" * 60)
    print("Binding energy summary (RuCu(0001))")
    print("=" * 60)
