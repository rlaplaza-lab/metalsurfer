...
def main():
    results_subdir = "ethane_ethene_acetylene_cu"
    results_dir = f"results_{results_subdir}"

    # Create Cu(111) slab from Materials Project mp-30.
    ...
    for smiles, name in MOLECULES:
        ...
        if results:
            ...
            print(
                f"Binding energy of {name} on Cu(111): {best.energy_adsorption:.4f} eV"
            )
            if orientations:
                print(
    ...
    # Final summary
    print("\n" + "=" * 60)
    print("Binding energy summary (Cu(111))")
    print("=" * 60)
