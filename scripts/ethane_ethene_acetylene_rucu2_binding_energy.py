...
Uses metalsurfer prepare_substrate to create RuCu2 alloy from Ru(0001) base slab.
...
def main() -> int:
    ...
    surface_type = "ethane_ethene_acetylene_rucu2"
    ...
    print(
        campaign.format_summary(
            title="Binding energy summary (ethane / ethene / acetylene on RuCu2)",
            results_dir=results_dir,
        )
    )
    return 0
