...
def main():
    parser = argparse.ArgumentParser(
        description="Furanic molecules on Ru(0001) with BO (100 placements, batches of 20)"
    )
    parser.add_argument(
        "--device",
    ...
    for smiles, name in MOLECULES:
        ...
        if results:
            ...
            print(
                f"Binding energy of {name} on Ru(0001): {best.energy_adsorption:.4f} eV"
            )
            if orientations:
                print(
    ...
    # Final summary
    print("\n" + "=" * 60)
    print("Binding energy summary (Ru(0001))")
    print("=" * 60)
